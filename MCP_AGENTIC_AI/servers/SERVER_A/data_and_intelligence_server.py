...
@mcp.tool()
def data_analysis(user_query:str, csv_filename:str, shared_folder: str)-> str:
    ...
    execution_results = execute_analysis_agent(user_query, shared_folder, csv_filename)
...
def data_visualization(user_query:str, csv_filename:str, shared_folder: str)-> str:
    ...
    logger.info(f"Starting data visualization with User query: {user_query}, CSV Filename: {csv_filename}, Shared Folder: {shared_folder}")
    execution_results = execute_plotting_agent(user_query, shared_folder, csv_filename)
